...
class ScrollingBackground {
    ...
    update() {
        // allows the background layers to wrap back around to the bottom. If we didn’t have 
        //this code, the backgrounds will just move off-screen and there will remain the black background.
